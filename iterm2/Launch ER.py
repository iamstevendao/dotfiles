...
tab_title = "ER"
color = iterm2.Color(49, 27, 146) # Material Deep Purple 900
panes = [
    { 
      "title": "Agents",
      "path": "~/dev/edvisor/el-agents",
      "scripts": ["meteor npm run start:prod"]
    },
    { 
      "title": "Core Services",
      "path": "~/dev/edvisor/el-core-services",
      "scripts": ["nvm use"]
    },
    { 
      "title": "Functions",
      "path": "~/dev/edvisor/el-functions",
      "scripts": ["nvm use"]
    },
]
